...
AV<- data.frame(outer(rep(month.abb,length = 96), month.abb,"==") + 0 )
# Creating dummies for 12 months


colnames(AV)<-month.abb # Assigning month names 
View(AV)
AirlinesData<-cbind(Airlines,AV)
...
attach(AirlinesData)
    ...
    ##### Splitting the data into the training and testing data set##
...
rmse_Quad 
##48.051 and Adjusted R-squared value is 79.12%##
...
rmse_Add_sea_Linear 
##  35.348 and Adjusted R squared value is 94.75%##
...
rmse_multi_add_sea 
##10.51 and Adjusted R squared value is 97.23%###
